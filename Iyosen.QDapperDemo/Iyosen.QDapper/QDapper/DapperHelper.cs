...
namespace Iyosen.QDapper
{
    public class DapperHelper
    {
        ...
        {
            JObject prop = GetJsonByPath("appsettings.json");
            // 这里为了方便演示直接写的字符串，实例项目中可以将连接字符串放在配置文件中，再进行读取。
            //_connection = @"Data Source=.;Initial Catalog=ELF_Community;User Id=sa;Password=123456;";            
            _connection = prop["ConnectionStrings"]["Conn"].ToString();
        }
        ...
        public static JObject GetJsonByPath(string path)
        {
